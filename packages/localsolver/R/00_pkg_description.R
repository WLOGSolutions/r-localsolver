...
#' 
#' \strong{LocalSolver is required.} It is highly recommended that the LocalSolver software is installed 
#' before the R package. The package have been tested with v4.0 of LocalSolver.\cr   
